...
| **Kiosk Satellite** | The Google Home layout in the [Kiosk Satellite](https://github.com/jxlarrea/kiosk-satellite) app's palette: warm neutral surfaces, teal accents and left-aligned text. Four-color gradient bar in the Kiosk Satellite logo colors, and the thinking indicator is a miniature of the logo's four bars. Supports light and dark mode which automatically follows your HA theme or can be forced via the Theme Mode setting |
